...
genetic_map <- read.csv("SNP-location2.csv", header = TRUE, stringsAsFactors = FALSE) 
genetic_map[1:2,]
...
# wheat_geno.csv and wheat_gmap.csv were to be used in rqtl.R script
...
# To work in queuing system with Biomart there are other versions like MartShell etc.

##******************************************************************************
##@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
# following for the genes found in differentially alternatively spliced introns 
